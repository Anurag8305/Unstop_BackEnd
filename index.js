...
const { ticketRouter } = require("./Routes/newCoahRoute");
...
// // Connect to MongoDB
// mongoose
// 	.connect("mongodb://127.0.0.1:27017/train_seats_app", {
...
// 		res
// 			.status(200)
// 			.send({ success: true, message: "Coach Added Successfully", coach });
// 	} catch (error) {
...
// 		const { rowIndex, seatIndex } = findNearestAvailableSeats(
// 			coach.seats,
// 			numSeats
// 		);
...
// 			return res
// 				.status(400)
// 				.json({ message: "Not enough adjacent seats available" });
// 		}
